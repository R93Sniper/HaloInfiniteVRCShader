...
Shader "HaloInfinte/-Advanced- Halo Infinite Spartan Armor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_12_0_g184 = _Zone0TileableIntensity;
			float3 Zone0Color112 = saturate( ( ( _Color * saturate( ( Zone0MaskBase52 - EdgeWear27 ) ) ).rgb * ( ( DetailColor56 * temp_output_12_0_g184 ) + ( 1.0 - temp_output_12_0_g184 ) ) ) );
			...
			float temp_output_12_0_g183 = _Zone2TileableIntensity;
			float3 Zone2Color111 = saturate( ( ( _Color2 * saturate( ( CC1G13 - EdgeWear27 ) ) ).rgb * ( ( DetailColor56 * temp_output_12_0_g183 ) + ( 1.0 - temp_output_12_0_g183 ) ) ) );
			float temp_output_12_0_g181 = _Zone3TileableIntensity;
			float3 Zone3Color114 = saturate( ( ( _Color3 * saturate( ( CC1B14 - EdgeWear27 ) ) ).rgb * ( ( DetailColor56 * temp_output_12_0_g181 ) + ( 1.0 - temp_output_12_0_g181 ) ) ) );
			float temp_output_12_0_g182 = _Zone4TileableIntensity;
			float3 Zone4Color110 = saturate( ( ( _Color4 * saturate( ( CC2R16 - EdgeWear27 ) ) ).rgb * ( ( DetailColor56 * temp_output_12_0_g182 ) + ( 1.0 - temp_output_12_0_g182 ) ) ) );
			...
			float3 lerpResult319 = lerp( ( Zone0Color112 + Zone1Color113 + Zone2Color111 + Zone3Color114 + Zone4Color110 + EdgeWearColor108 + ColorCC2B411 ) , Zone6Color109 , ( AO9 * GrungeMask34 ));
			...
			float temp_output_12_0_g186 = _Zone5TileableIntensity;
			float3 Zone5ColorMix115 = saturate( ( ( _Color5 * temp_output_156_0 ).rgb * ( ( DetailColor56 * temp_output_12_0_g186 ) + ( 1.0 - temp_output_12_0_g186 ) ) ) );
			#if defined(_EMMISIVEZONE_NOEMISSIVE)
				float3 staticSwitch407 = temp_cast_5;
...
/*ASEBEGIN
Version=18909
0;31;1920;1027;8318.581;2461.739;6.32977;True;False
...
Node;AmplifyShaderEditor.FunctionNode;213;-3907.676,483.549;Inherit;False;MF_SimpleDetailDiffuse;-1;;184;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;215;-1405.007,468.363;Inherit;False;MF_SimpleDetailDiffuse;-1;;182;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;216;-2638.632,1023.091;Inherit;False;MF_SimpleDetailDiffuse;-1;;181;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;214;-2669.785,485.125;Inherit;False;MF_SimpleDetailDiffuse;-1;;183;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;172;140.0589,336.4792;Inherit;False;2190.679;594.2961;Final Color Mixing;25;137;160;131;319;321;318;127;320;135;136;133;134;132;130;125;128;122;123;124;121;413;412;365;363;364;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;128;179.3442,718.3642;Inherit;False;108;EdgeWearColor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;413;180.4446,787.9225;Inherit;False;411;ColorCC2B;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;130;472.0627,504.8083;Inherit;False;7;7;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;212;-1380.865,1024.567;Inherit;False;MF_SimpleDetailDiffuse;-1;;186;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;173;410.7229,-373.6451;Inherit;False;654.9984;523.1563;Output;7;0;142;139;141;138;192;140;v 0.4 Bumpy Roads Ahead;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=AB818DF1D3BF748BB1B52636D525F85D4E1DF392