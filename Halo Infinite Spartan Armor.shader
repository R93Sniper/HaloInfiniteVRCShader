...
Shader "HaloInfinte/ArmorBase"
{
	Properties
	{
		...
		[NoScaleOffset]_CC1Mask("CC1 Mask", 2D) = "white" {}
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 lerpResult4_g52 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone0TileableIntensity);
			float3 Zone0Color112 = saturate( ( ( _Color0 * saturate( ( Zone0Mask52 - EdgeWear27 ) ) ).rgb * lerpResult4_g52 ) );
			float3 lerpResult4_g55 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone1TileableIntensity);
			float3 Zone1Color113 = saturate( ( ( _Color1 * saturate( ( CC1R12 - EdgeWear27 ) ) ).rgb * lerpResult4_g55 ) );
			float3 lerpResult4_g54 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone2TileableIntensity);
			float3 Zone2Color111 = saturate( ( ( _Color2 * saturate( ( CC1G13 - EdgeWear27 ) ) ).rgb * lerpResult4_g54 ) );
			float3 lerpResult4_g57 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone3TileableIntensity);
			float3 Zone3Color114 = saturate( ( ( _Color3 * saturate( ( CC1B14 - EdgeWear27 ) ) ).rgb * lerpResult4_g57 ) );
			float3 lerpResult4_g51 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone4TileableIntensity);
			float3 Zone4Color110 = saturate( ( ( _Color4 * saturate( ( CC2R16 - EdgeWear27 ) ) ).rgb * lerpResult4_g51 ) );
			float3 lerpResult4_g56 = lerp( float3( 1,1,1 ) , ( float3( 0.5,0.5,0.5 ) + DetailColor56 ) , _Zone5TileableIntensity);
			float3 Zone5Color115 = saturate( ( ( _Color5 * saturate( ( CC2G17 - EdgeWear27 ) ) ).rgb * lerpResult4_g56 ) );
...
/*ASEBEGIN
Version=18301
63;85;1529;910;6556.626;2158.222;5.429865;True;False
...
Node;AmplifyShaderEditor.SamplerNode;8;-2688,0;Inherit;True;Property;_CC2Mask;CC2 Mask;2;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;ae2e37586d28e274eb9eb9a0b4e58352;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1712,128;Inherit;False;Property;_MaxGrungePower;Max Grunge Power;22;0;Create;True;0;0;False;0;False;3;8.4;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;7;-3328,0;Inherit;True;Property;_CC1Mask;CC1 Mask;1;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;090a3f50c438cc14abfb68c7fd2a8a22;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-2015,-214;Inherit;False;Property;_EdgeWearAmmount;EdgeWearAmmount;24;0;Create;True;0;0;False;0;False;0.9;0.938;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;26;-1691.538,-171.1129;Inherit;False;Property;_MaxEdgeWearPower;Max EdgeWear Power;25;0;Create;True;0;0;False;0;False;10;28;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;170;-2070.864,926.5673;Inherit;False;1221;510;ColorZone5;11;158;94;157;156;97;95;92;91;96;93;115;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;164;-4605.476,385.5491;Inherit;False;1228.8;531.4999;ColorZone0;11;47;53;46;163;4;61;62;60;54;57;112;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;166;-2119.803,386.3632;Inherit;False;1245.797;485.7687;ColorZone4;11;87;155;154;90;153;88;84;85;89;86;110;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;165;-3371.885,387.1251;Inherit;False;1249.1;473.4995;ColorZone2;11;152;73;151;150;76;74;75;71;70;72;111;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;169;-3365.632,925.0906;Inherit;False;1287.807;528;ColorZone3;11;149;80;148;83;147;77;78;82;79;114;81;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;168;-4606.449,923.1078;Inherit;False;1234;489;ColorZone1;11;63;143;144;68;145;64;65;69;66;67;113;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;58;-4227.786,-9.164495;Inherit;True;Property;_DetailTexture;DetailTexture;4;0;Create;True;0;0;False;0;False;-1;None;3ee0c06ad3bf2134fb04893b5d83e42a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;104;-818.4949,439.5759;Inherit;False;Property;_Color6;Color 6;20;0;Create;True;0;0;False;0;False;0,0,0,0;0.6981132,0.6319392,0.510413,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;68;-4479.449,973.1078;Inherit;False;Property;_Color1;Color 1;10;0;Create;True;0;0;False;0;False;0,1,0,0;0.1981131,0.1981131,0.1981131,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;83;-3214.632,975.0906;Inherit;False;Property;_Color3;Color 3;14;0;Create;True;0;0;False;0;False;0,1,1,0;0.3490565,0.3490565,0.3490565,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;97;-1956.865,976.5673;Inherit;False;Property;_Color5;Color 5;18;0;Create;True;0;0;False;0;False;1,0,1,0;0.5754716,0,0.5754716,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;61;-4555.476,802.0487;Inherit;False;Property;_Zone0TileableIntensity;Zone0 Tileable Intensity ;9;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;150;-2943.24,633.4312;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;90;-1981.007,436.3632;Inherit;False;Property;_Color4;Color 4;16;0;Create;True;0;0;False;0;False;1,1,0,0;0.764151,0.764151,0.7605464,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;76;-3245.785,437.1251;Inherit;False;Property;_Color2;Color 2;12;0;Create;True;0;0;False;0;False;0,0,1,0;0.1132074,0.1132074,0.1132074,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;105;-789.3092,982.5456;Inherit;False;Property;_Color7;EdgeWearColor;23;0;Create;False;0;0;False;0;False;0.846,0.825,0.839,0;0.8867924,0.8867924,0.8867924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;4;-4483.676,435.5491;Inherit;False;Property;_Color0;Color 0;8;0;Create;True;0;0;False;0;False;1,0,0,0;0,0.2779874,0.6415094,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;79;-2638.632,1023.091;Inherit;False;MF_SimpleDetailDiffse;-1;;57;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;93;-1380.865,1024.567;Inherit;False;MF_SimpleDetailDiffse;-1;;56;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;67;-3903.45,1021.108;Inherit;False;MF_SimpleDetailDiffse;-1;;55;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;86;-1405.007,468.363;Inherit;False;MF_SimpleDetailDiffse;-1;;51;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;72;-2669.785,485.125;Inherit;False;MF_SimpleDetailDiffse;-1;;54;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;57;-3907.676,483.549;Inherit;False;MF_SimpleDetailDiffse;-1;;52;e6e4a2444c47f7a42bdb4a4522f8e7eb;0;3;1;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;12;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;179;774.6708,1141.036;Inherit;False;Property;_EmmisiveZone;EmmisiveZone;6;0;Create;True;0;0;False;0;False;1;0;0;True;;KeywordEnum;8;NoEmissive;Zone0Emissive;Zone1Emissive;Zone2Emissive;Zone3Emissive;Zone4Emissive;Zone5Emissive;Zone6Emissive;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;189;791.2858,1063.958;Inherit;False;Property;_EmissiveIntencity;EmissiveIntencity;7;0;Create;True;0;0;False;0;False;0;2.74;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;160;1499.2,540.3264;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;6;-2688,-256;Inherit;True;Property;_BumpMap;NormalMap;3;1;[NoScaleOffset];Create;False;0;0;False;0;False;-1;None;3baaaab70bb46474fa65c370ec02e6f3;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;173;1086,-178;Inherit;False;729;505;Output;7;142;140;141;139;138;0;192;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;141;1135,160;Inherit;False;11;Smoothness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;177;-4648.245,-406.7653;Inherit;False;100;100;Made for assets from Halo Infinite, Protoyped in Unreal Engine by R93_Sniper, ported to Unity in amplify by PointDevice;0;Made for assets from Halo Infinite, Protoyped in Unreal Engine by R93_Sniper, ported to Unity in amplify by PointDevice;1,1,1,1;0;0
...
WireConnection;79;6;78;0
WireConnection;79;12;82;0
WireConnection;93;1;91;0
WireConnection;93;6;92;0
WireConnection;93;12;96;0
WireConnection;188;0;98;0
WireConnection;67;1;65;0
WireConnection;67;6;66;0
WireConnection;67;12;69;0
WireConnection;9;0;5;1
WireConnection;129;0;107;0
WireConnection;86;1;84;0
WireConnection;86;6;85;0
WireConnection;86;12;89;0
WireConnection;72;1;70;0
WireConnection;72;6;71;0
WireConnection;72;12;75;0
WireConnection;57;1;54;0
WireConnection;57;6;60;0
WireConnection;57;12;62;0
...
ASEEND*/
//CHKSM=97571469737FE72739541DE99ECF0C15094BF777